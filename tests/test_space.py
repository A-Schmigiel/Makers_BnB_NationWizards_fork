...
def test_create_space():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night=100.00, user_id=1, upload_image="test url", dates_booked=["2025-05-20", "2025-05-30"])
    ...
    assert space.upload_image == "test url"
...
def test_is_valid_with_blank_price_per_night():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night="", user_id=1, upload_image="test url", dates_booked=["2025-05-20", "2025-05-30"])
...
def test_is_valid_with_blank_user_id():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night=100.00, user_id="", upload_image="test url", dates_booked=["2025-05-20", "2025-05-30"])
...
def test_is_valid_with_blank_dates_booked():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night=100.00, user_id=1, upload_image="test url", dates_booked=[])
    
    assert space.is_valid() == False

#Space is invalid when url field is empty
def test_is_valid_with_blank_upload_image():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night=100.00, user_id=1, upload_image="", dates_booked=["2025-05-20", "2025-05-30"])
...
#generate_errors for missing upload image url
def test_generate_errors_with_missing_upload_image_url():
    space = Space(id=1, name="Green Lodge", description="A lodge that is green", 
                price_per_night=100.00, user_id=1, upload_image="", dates_booked=["2025-05-20", "2025-05-30"])
    
    errors = space.generate_errors()
    assert "Upload image can't be blank" in errors
...
def test_space_inequality():
    ...
    space2 = Space(id=2, name="Hobbitsville", description="A place for small people", 
                price_per_night=150.00, user_id=2, upload_image="test url", dates_booked=["2025-06-01", "2025-06-10"])
